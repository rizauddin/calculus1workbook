...
% 2. scheme of works
%--------------
\newif\ifincludeMATOneEightThree
\newif\ifincludeMATFourTwoOne
\includeMATOneEightThreefalse
\includeMATFourTwoOnefalse
%\includeMATFourTwoOnefalse
...
%-------------
% Add past year questions
%-------------
\newcommand{\pastpaper}[4]{%
  \includepdf[
    pages=1,
    scale=#1,
    pagecommand={#2}
