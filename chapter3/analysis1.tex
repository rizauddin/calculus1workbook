...
\noindent Determine the intervals where the following functions are decreasing or increasing.
...
\problemans{$\displaystyle \frac{x-1}{x+2}$}{concave up: $\{(-\infty, -2)\}$; concave down: $\{(-2, +\infty)\}$; no inflection point}
